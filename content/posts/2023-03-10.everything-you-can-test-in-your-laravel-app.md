...
All test examples are written with the testing framework [PEST](https://pestphp.com). Still, a lot will be very similar to PHPUnit. Be aware that some examples are simplified to emphasize the shown concept.
