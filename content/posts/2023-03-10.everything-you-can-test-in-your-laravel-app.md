...
All test examples are written with the testing framework [PEST](https://pestphp.com). Still, a lot will be very similar to PHPUnit, and the focus is on the testing concepts.
...
When dealing with many validation rules, using [datasets](https://pestphp.com/docs/datasets) can be helpful. This can clean up your tests a lot.
...
When working with code with dependencies, it can be helpful to mock them. This will let you concentrate on the logic of your code and not on the dependencies.
