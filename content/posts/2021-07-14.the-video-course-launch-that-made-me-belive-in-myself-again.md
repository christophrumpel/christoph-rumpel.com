...
I released Mastering PhpStorm after my Laracon Online talk exactly six months ago. Conferences always work excellent for such releases because you already have the attention of a lot of viewers. It gives your launch an extra boost.
...
For this course, I partnered up again with the guys from [Complemind](https://complemind.com/) (like I did with Laravel Core Adventures). Markus and Martin are friends of mine and excellent designers. With their help, we came up with the beautiful spacy-80s-look for Mastering PhpStorm, which you know now.
...
I'm so pleased with the design of this course, and I believe we did a fantastic job here. But, still, `no one ever mentioned the design`. And with no one, I mean, not a single person ever mentioned the design. With the massive amount of work we put into the design, this feels very odd.
...
While working with PhpStorm, I hated how it looked by default. I spend a lot of time changing that. Additionally, PhpStorm has so many features that it isn't easy to know what to use. I felt the pain, but I didn't realize others were too. `Mastering PhpStorm is an opinionated course` where I share what tools to use and how.
...
Purchasing Power Parity (or PPP) means that your price should reflect the economic standards of your buyer's country. For example, €79 is quite some money in Europe, but in India, it's worth way more. As a result, you have to provide different prices for different countries.
...
Every week I provided a new trick for PhpStorm. I made a little video to showcase the tip or tricks and tweeted that. After 30 tips & tricks, I created a [little website](https://masteringphpstorm.com/tips-and-tricks) where you can look through all of them more easily than on Twitter.
