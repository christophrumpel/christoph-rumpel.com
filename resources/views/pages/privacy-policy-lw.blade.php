<x-main-layout title="Privacy Policy Mastering PhpStorm" page="privacy-policy-mp">
    <main class="post-markdown-styles">
        <article>
            ...
            <h1>Business Privacy Policy - laravelworkflows.com</h1>

            <p>This privacy policy sets out how laravelworkflows.com uses and protects any information that you give when you visit <a href="https://laravelworkflows.com/">laravelworkflows.com</a>.
            </p>

            <p>laravelworkflows.com is committed to ensuring that your privacy is protected. Should we ask you to provide
                certain information by which you can be identified when using laravelworkflows.com, then you can be
                assured that it will only be used in accordance with this privacy statement.</p>

            <p>laravelworkflows.com may change this policy from time to time by updating this page. You should check this
                page
            ...
            <ul>
                <li>Send news about the product Laravel Workflows</li>
            </ul>
            ...
            <ul>
                ...
                <li>The email is sent through <a href="https://mailchimp.com/legal/privacy/">mailchimp</a>.
                </li>
            </ul>
            ...
            <h2>Our Details</h2>
            <p>Laravel Workflows is owned and operated by Christoph Rumpel & Sebastian Schöps.</p>
